...
public static class MailComponentBase
{
    ...
    public class Server : BlazeComponent
    {
        ...
        public Server()
        {
            RegisterCommand(new RpcCommandFunc<UpdateMailSettingsRequest, EmptyMessage, EmptyMessage>()
            {
            ...
            RegisterCommand(new RpcCommandFunc<SendMailToSelfRequest, EmptyMessage, EmptyMessage>()
            {
            ...
            RegisterCommand(new RpcCommandFunc<SetMailOptInFlagsRequest, EmptyMessage, EmptyMessage>()
            {
            ...
            RegisterCommand(new RpcCommandFunc<SetMailPrefRequest, EmptyMessage, EmptyMessage>()
            {
            ...
            RegisterCommand(new RpcCommandFunc<GetMailSettingsRequest, GetMailSettingsResponse, EmptyMessage>()
            {
        ...
        /// Request type: <see cref="UpdateMailSettingsRequest"/><br/>
        /// Response type: <see cref="EmptyMessage"/><br/>
        /// </summary>
        public virtual Task<EmptyMessage> UpdateMailSettingsAsync(UpdateMailSettingsRequest request, BlazeRpcContext context)
        {
        ...
        /// Request type: <see cref="SendMailToSelfRequest"/><br/>
        /// Response type: <see cref="EmptyMessage"/><br/>
        /// </summary>
        public virtual Task<EmptyMessage> SendMailToSelfAsync(SendMailToSelfRequest request, BlazeRpcContext context)
        {
            throw new MailException(ServerError.ERR_COMMAND_NOT_FOUND);
        }
        ...
        /// Request type: <see cref="SetMailOptInFlagsRequest"/><br/>
        /// Response type: <see cref="EmptyMessage"/><br/>
        /// </summary>
        public virtual Task<EmptyMessage> SetMailOptInFlagsAsync(SetMailOptInFlagsRequest request, BlazeRpcContext context)
        {
            throw new MailException(ServerError.ERR_COMMAND_NOT_FOUND);
        }
        ...
        /// Request type: <see cref="SetMailPrefRequest"/><br/>
        /// Response type: <see cref="EmptyMessage"/><br/>
        /// </summary>
        public virtual Task<EmptyMessage> SetMailPrefAsync(SetMailPrefRequest request, BlazeRpcContext context)
        {
            throw new MailException(ServerError.ERR_COMMAND_NOT_FOUND);
        }
        ...
        /// Request type: <see cref="GetMailSettingsRequest"/><br/>
        /// Response type: <see cref="GetMailSettingsResponse"/><br/>
        /// </summary>
        public virtual Task<GetMailSettingsResponse> GetMailSettingsAsync(GetMailSettingsRequest request, BlazeRpcContext context)
        {
            throw new MailException(ServerError.ERR_COMMAND_NOT_FOUND);
        }
