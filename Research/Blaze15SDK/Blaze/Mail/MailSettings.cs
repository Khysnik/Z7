...
namespace Blaze15SDK.Blaze.Mail;
...
public class MailSettings : Tdf
{
    ...
    private TdfEnum<Blaze15SDK.Blaze.Mail.EmailFormatPref> _emailFormatPref = new(__typeInfos[0]);
    private TdfEnum<Blaze15SDK.Blaze.Mail.EmailOptInFlags> _emailOptInFlags = new(__typeInfos[1]);
    ...
    public Blaze15SDK.Blaze.Mail.EmailFormatPref EmailFormatPref
    {
        get => _emailFormatPref.Value;
        set => _emailFormatPref.Value = value;
    }

    public Blaze15SDK.Blaze.Mail.EmailOptInFlags EmailOptInFlags
    {
