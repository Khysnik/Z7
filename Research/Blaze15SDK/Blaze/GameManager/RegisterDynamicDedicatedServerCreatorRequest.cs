...
public class RegisterDynamicDedicatedServerCreatorRequest : Tdf
{
    ...
    private TdfMap<string, Blaze15SDK.Blaze.GameManager.MachineLoadCapacity> _machineLoadCapacityMap = new(__typeInfos[0]);

    public RegisterDynamicDedicatedServerCreatorRequest()
    {
        __members = [ _machineLoadCapacityMap ];
    }
    ...
    public IDictionary<string, Blaze15SDK.Blaze.GameManager.MachineLoadCapacity> MachineLoadCapacityMap
    {
