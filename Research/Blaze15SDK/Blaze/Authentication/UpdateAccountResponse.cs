...
public class UpdateAccountResponse : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        new TdfMemberInfo("PCLoginToken", "mPCLoginToken", 0xC23D2B00, TdfType.String, 0, true), // Tag: PCTK
    ];
    private ITdfMember[] __members;
    private TdfString _pCLoginToken = new(__typeInfos[0]);
    public UpdateAccountResponse() { __members = [ _pCLoginToken ]; }
    ...
    public string PCLoginToken { get => _pCLoginToken.Value; set => _pCLoginToken.Value = value; }
}
