...
public class UpdateAccountRequest : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        new TdfMemberInfo("CurrentPassword", "mCurrentPassword", 0x8F0DE400, TdfType.String, 0, true), // Tag: CPWD
        new TdfMemberInfo("Country", "mCountry", 0x8F4CB900, TdfType.String, 1, true), // Tag: CTRY
        new TdfMemberInfo("DOB", "mDOB", 0x92F88000, TdfType.String, 2, true), // Tag: DOB
        new TdfMemberInfo("Language", "mLanguage", 0xB21BA700, TdfType.String, 3, true), // Tag: LANG
        new TdfMemberInfo("Email", "mEmail", 0xB61A6C00, TdfType.String, 4, true), // Tag: MAIL
        new TdfMemberInfo("GlobalOptin", "mGlobalOptin", 0xBF0D1100, TdfType.UInt8, 5, true), // Tag: OPT1
        new TdfMemberInfo("ThirdPartyOptin", "mThirdPartyOptin", 0xBF0D1300, TdfType.UInt8, 6, true), // Tag: OPT3
        new TdfMemberInfo("Password", "mPassword", 0xC21CF300, TdfType.String, 7, true), // Tag: PASS
        new TdfMemberInfo("ParentalEmail", "mParentalEmail", 0xC32BB400, TdfType.String, 8, true), // Tag: PRNT
        new TdfMemberInfo("UserId", "mUserId", 0xD6990000, TdfType.Int64, 9, true), // Tag: UID
    ];
    ...
    public UpdateAccountRequest() { __members = [ _currentPassword, _country, _dOB, _language, _email, _globalOptin, _thirdPartyOptin, _password, _parentalEmail, _userId ]; }
    ...
    public string CurrentPassword { get => _currentPassword.Value; set => _currentPassword.Value = value; }
    ...
    public byte GlobalOptin { get => _globalOptin.Value; set => _globalOptin.Value = value; }
    public byte ThirdPartyOptin { get => _thirdPartyOptin.Value; set => _thirdPartyOptin.Value = value; }
